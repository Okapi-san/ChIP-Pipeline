...
```
   ...
   +-------------------+                        v
```
![image](https://raw.githubusercontent.com/Okapi-san/ChIP-Pipeline/master/matrix_final.tsv%20.jpg?token=ALF4CHAN23NNDWQTTZ52B5C6RCAO4)
